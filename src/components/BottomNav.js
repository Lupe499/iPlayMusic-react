  ...
  return (
    <nav className="BottomNav">
        <ul className="BottomUl">
            ...
            <li><Link to="/simpleplayer"><i style={{color: current2}} className="fas fa-microphone-alt"></i></Link></li>
            <li><ion-icon style={{color: current3}} name="radio-outline"></ion-icon></li>
            <li><Link to="/categories"><i style={{color: current4}} class="fas fa-adjust"></i></Link></li>
            <li><Link to="/albums"><i style={{color:current5}} class="fas fa-cog"></i></Link></li>
        </ul>
    </nav>
  );
}
